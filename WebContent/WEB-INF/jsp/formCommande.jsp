...
<body>
	...
	<div>
		<form method="post" action="<c:url value="/createCommande"/>">
			...
			<fieldset>
				...
				<input type="text" id="v" name="dateCommande"
					value="<c:out value="${commande.date_cmd}"/>" size="30" maxlength="30"
				...
				<br /> <label for="modePaiementCommande">Mode de paiement <span
					...
					value="<c:out value="${commande.mode_paiement}"/>" size="30"
